...
{	
	...
	// load images
	backgroundTexture.loadFromFile("images/background2.png");// load the background sprite
	backgroundSprite.setTexture(backgroundTexture);

	blockTexture.loadFromFile("images/tiles2.png");	// load the tetris block sprite
	...
	const Point gameboardOffset{ 55, 125 };		// the pixel offset of the top left of the gameboard 
