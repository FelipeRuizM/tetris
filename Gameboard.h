...
public:	
	...
	void setContent(const std::vector<Point>& points, const int content);
...
private:  // This is commented out to allow us to test. 
	...
	// - return: nothing
	void copyRowIntoRow(const int sourceY, const int targetY);
